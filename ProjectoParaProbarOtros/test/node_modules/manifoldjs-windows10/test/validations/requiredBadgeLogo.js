...
var constants = require('../../lib/constants'),  
    validation = require('../../lib/validationRules/requiredBadgeLogo');

var validIconSizes = ['24x24', '48x48'];
var manifestWithValidIconSizes = [{sizes : '24x24'}, {sizes : '48x48'}];

describe('Validation - Windows', function () {
  describe('requiredBadgeLogo', function () {
